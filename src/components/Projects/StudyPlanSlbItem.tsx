...
const StudyPlanSlbItem = () => {
    return (
        <>
            <ul className={styles['project-wrapper']}>
                <h1 className={styles['project-title']}>Project</h1>
                <li className={styles['project-list']}>
                    ...
                    />
                    <AppLink href={'/arduino'} label={'Arduino Simulator'}/>
                </li>
                <li className={styles['project-list']}>
                    <SvgIconComponent
                        width={25} height={25}
                    ...
                    />
                    <AppLink href={'/block'} label={'Block Coding'}/>
                </li>
            </ul>

            {/* SLB - Language */}
            <ul className={styles['project-wrapper']}>
                <h1 className={styles['project-title']}>Language</h1>
                <li className={styles['project-list']}>
                    <SvgIconComponent
                        width={25} height={25}
                    ...
                    />
                    <AppLink href={'/study'} label={'JavaScript'}/>
                </li>
            </ul>
        </>
    );
...
export default StudyPlanSlbItem;